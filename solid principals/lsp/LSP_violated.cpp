...
public:
    ...
    void processTransaction()
    {
        for (auto &account : accounts)
        {
            ...
            // Assuming all accounts support withdrawal (LSP Violation) -> the Bank client should work correctly without handeling any error. It assume that all the account have the withdraw functionallity. but here violation of Lsp is happening
            try
            {
